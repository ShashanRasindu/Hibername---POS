...
2. Clone the repo
```sh
git clone https://github.com/ShashanRasindu/Hibername---POS
```
...
Project Link: [https://github.com/ShashanRasindu/JPA---POS](https://github.com/ShashanRasindu/Hibername---POS)
